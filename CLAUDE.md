...
| **Ryan** | **OPEN-01 (blocks everything below)** → 08 adapter + Daily Metric Set → 09 RED → gate → **10 GREEN ← FR-WER-10 clears here** → OPEN-04 → 11 libraries → **14/15 (frontend views, per OPEN-09, agreed 23 Jul)** |
