...
| 17a | `verification/17a-acceptance-suite-RED.md` | 🔴 RED | ✅ Authored and run (RED), 26 Jul — suite fails at the 17b stub; awaiting human gate + freeze, `docs/P17A-RED-REPORT.md` |
